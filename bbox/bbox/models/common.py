...
from bbox.utils import TryExcept
from bbox.utils.dataloaders import exif_transpose, letterbox
from bbox.utils.general import (
    LOGGER,
    ROOT,
    Profile,
    check_requirements,
...
from bbox.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from bbox.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from bbox.export import export_formats
        from bbox.utils.downloads import is_url
